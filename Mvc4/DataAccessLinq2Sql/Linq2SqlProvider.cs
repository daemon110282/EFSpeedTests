...
{
	public class Linq2SqlProvider : ITestResultsProvider
	{
		protected NorthwindClassesDataContext context;

		private bool withTracking;

		public Linq2SqlProvider(bool withTracking)
		{
